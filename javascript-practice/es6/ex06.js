...
/* ex03 - 구조 분해 해야 할 객체의 속성 이름과 변수 이름이 다를 때 */
const person = {
    n: '마이콜',
    c: 'korea'
};
...
/* 
    - 전개연산자
    배열 자체(ex/ arr)를 출력하게 되면 [arr1, arr2, arr3] 이런 식으로 출력된다.
    ...arr 이렇게 전개연산자를 사용하면 배열 요소 하나하나에 접근해서 출력됨
*/
